"""Release0099 must retain group records/backups and include removal controls."""
...
from release_gc_app_group_removal import (
    PREVIOUS_SCHEMA,
    SCHEMA,
    GCAppGroupRemovalRelease,
)
...
class GCAppGroupRemovalReleaseTests(unittest.TestCase):
    def setUp(self):
        ...
        self.release = GCAppGroupRemovalRelease(REVISION, self.root)
    ...
    def test_prepare_activate_preserves_history_artifacts_and_provider_configuration(self):
        ...
        self.assertEqual([item["schema"] for item in backups], ["0098_notification_saved_delete"])
        self.assertEqual(self.fake.schema, "0099_gc_group_access_removal")
