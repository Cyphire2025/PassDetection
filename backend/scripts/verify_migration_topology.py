...
EXPECTED_HEAD = "0095_mobile_fcm_delivery"
...
def main() -> int:
    ...
    if head.down_revision != "0094_whatsapp_receipt_inbox":
    ...
    print(
        "Alembic topology verified: 0095 follows 0094, 0093, 0092, 0091, 0090, 0089 and the preserved 0088 merge "
