...
EXPECTED_HEAD = "0096_mobile_phone_lookup"
...
def main() -> int:
    ...
    if head.down_revision != "0095_mobile_fcm_delivery":
    ...
    print(
        "Alembic topology verified: 0096 follows 0095, 0094, 0093, 0092, 0091, 0090, 0089 and the preserved 0088 merge "
