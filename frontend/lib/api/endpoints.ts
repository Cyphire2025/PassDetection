...
export const API_ENDPOINTS = {
  ...
  whatsapp: {
    ...
    sourceGroups: "/api/v1/whatsapp/source-groups",
    sourceGroupPreview: (groupId: string) =>
      `/api/v1/whatsapp/source-groups/${groupId}/preview`,
    sourceContacts: (groupId: string) =>
      `/api/v1/whatsapp/groups/${groupId}/source-contacts`,
    createFromClientGroup: "/api/v1/whatsapp/groups/from-client-group",
    ...
    groupExport: (groupId: string) => `/api/v1/whatsapp/groups/${groupId}/export`,
    ...
    previewRecipientsResend: (groupId: string) =>
      `/api/v1/whatsapp/groups/${groupId}/recipients/resend/preview`,
    ...
    documentActivityDeliveries: (batchId: string) =>
      `/api/v1/whatsapp/activities/document/${batchId}/deliveries`,
  },
  ...
  passports: {
    ...
    requestContactOtp: (id: string) => `/api/v1/passports/${encodeURIComponent(id)}/contact-otp/request`,
    verifyContactOtp: (id: string) => `/api/v1/passports/${encodeURIComponent(id)}/contact-otp/verify`,
