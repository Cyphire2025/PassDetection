        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 text-left shadow-sm">
          ...
          <ul className="space-y-2 text-sm text-slate-600">
            {[
              ...
              "Fast browser-side positioning and lighting guidance",
              "Mobile-first manual passport and Visa Photo capture",
              "Single-pass perspective correction before upload",
              "Final captured-image validation with review handling",
              "Gemini-based passport field extraction from uploaded images",
